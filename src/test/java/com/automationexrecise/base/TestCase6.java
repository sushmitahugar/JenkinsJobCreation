...
import com.automationexrecise.listeners.RetryAnalyzer;
...
public class TestCase6 extends BaseTest {
	...
	public void ITC01(String name, String email, String gender, String psw, String date, String month, String year,
		...
		Reporter.log("Auto jenkins triggerring  4", true);
		ChainTestListener.log("Auto jenkins triggerring 4");
		logger.info("Auto jenkins triggerring  4");
